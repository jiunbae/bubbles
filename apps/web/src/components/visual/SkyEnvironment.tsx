...
// ═══════════════════════════════════════════════════════════════════
// Camera-mode aware lighting — shared across all themes
// ═══════════════════════════════════════════════════════════════════

/** Neutral white lighting for camera/AR mode so bubbles are well-lit */
function CameraLighting({ sunPosition }: { sunPosition: [number, number, number] }) {
  return (
    <>
      <ambientLight color="#ffffff" intensity={1.5} />
      <directionalLight color="#ffffff" intensity={2.0} position={sunPosition} />
    </>
  );
}
